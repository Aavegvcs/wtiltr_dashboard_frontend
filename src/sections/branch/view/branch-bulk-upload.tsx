...
const BranchBulkUploadModal = ({ open, onClose, refreshData, insuranceCompany }: any) => {
  ...
  const handleDownloadSample = () => {
    ...
    link.href = url;
    link.setAttribute('download', 'sample_branch_template.csv');
                ...
                <Table size="small" stickyHeader>
                  <TableHead sx={{ backgroundColor: '#f5f5f5' }}>
                    <TableRow>
                      ...
                      <TableCell sx={{ fontWeight: 'bold', width: '40%' }}>Branch Name</TableCell>
