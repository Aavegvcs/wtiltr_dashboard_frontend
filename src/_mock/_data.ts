...
export const _myAccount = () => {
  ...
  return {
    displayName: auth?.user?.firstName || 'Guest User',
    email: auth?.user?.email || 'guest@example.com',
    // photoURL: auth? || '/assets/images/avatar/default.webp',
...
export const _employee = [...Array(24)].map((_, index) => ({
  id: Number(index),
  name: String(index),
  role: String(index),
